...
text = llm.create_chat_completion(
    messages=[
        ...
        {
            "role": "user",
            "content": "Write a few sentences for Hackergame 2024 (中国科学技术大学 (University of Science and Technology of China) 第十一届信息安全大赛) in English. The more funny and unreal the better. About 100 words.",
        },
    ]
